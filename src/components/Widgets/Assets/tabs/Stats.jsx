...
export default function Stats({ transactions, tokens }) {
	...
	return (
		<Flex vertical gap={16}>
			<Row gutter={[8, 8]}>
				<Col span={8}><CustomStatistic value={purchase < 0 ? 0 : purchase} title={"Вложено"} prefix={"$"} /></Col>
				<Col span={8}><CustomStatistic value={value} title={"Текущая стоимость"} prefix={"$"} /></Col>
				<Col span={8}><CustomStatistic value={income} title={"Доход"} prefix={"$"} painted /></Col>
