	...
	return (
		<>
			<Card size={"small"} hidden={!showDesc}>
				<p>Сравнение стратегии HODL с внесением активов в v2 пулы, когда кол-во токенов в позиции остаётся постоянным вне зависимости от изменения цены. Можно указать доходность позиции и её продолжительность для приблезительного учёта комиссионных.<br /><br /></p>
			</Card>
