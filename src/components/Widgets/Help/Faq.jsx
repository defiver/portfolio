...
export default function FAQ() {
	const items = [
		...
		},
		{
			...
			children: <p>Это показатель газа в сети эфира. Значение обновляется каждые 5 минут. Также его можно обновить нажатием на значок. Данные беруться с сайта blocknative.com.</p>,
		},
		{
			key: "pairs",
