...
export default function FAQ() {
	const items = [
		...
		},
		{
			...
			children: <p>Это показатель газа в сети эфира. Значение обновляется каждые 5 минут. Также его можно обновить нажатием на сами цифры. Данные беруться с сайта blocknative.com. Нажатии на значок вызывает виджет с основной рыночной информацией <i>(капитализация, индекс страха/жадности, топ валют)</i>. Данные беруться с сайта cryptorank.io.</p>,
		},
		{
			key: "pairs",
			label: "Что за значок с ещё одним графиком?",
			children: <p>Нажатие на него вызывает панель с графиками котировок для произвольных пар токенов. Цены загружаются каждый раз при открытии графика. Данные беруться с сайта livecoinwatch.com.</p>,
		},
	]
