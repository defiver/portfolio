...
export default function Help() {
  ...
  const items = [
    ...
    },
    {
      ...
      children: <p>Нажатие на него вызывает окно, через которое можно экспортировать/импортировать данные. Также можно нажать <code>Import test data</code>, чтобы посмотреть тестовые позиции и познакомится с функционалом приложения.</p>,
    },
    // {
    //   key: "9",
